...
export const SUPPORTED_WITHOUT_MULTICALL = [77, 31337, 80001]
export const SUPPORTED_NETWORKS = [1, 4, 42, 100, 137].concat(SUPPORTED_WITHOUT_MULTICALL)
// TODO: Remove once we have versioning package
export const NETWORKS_TO_IGNORE_VERSION_CHECKS = [100, 137, 31337, 80001]
