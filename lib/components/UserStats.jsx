      ...
      >
        <StatContainer>
          <BlueLineStat
            ...
            value={
              <>
                {displayAmountInEther(usersTokenBalance, { precision: 2, decimals })}&nbsp;
                <span className='text-default-soft opacity-60'> {tokenSymbol || 'TOKEN'}</span>
              </>
            }
          />
        </StatContainer>
        ...
        <StatContainer>
          <BlueLineStat
            ...
            value={
              <>
                {displayAmountInEther(usersTokenAllowance, { precision: 0, decimals })}&nbsp;
                <span className='text-default-soft opacity-60'>{tokenSymbol || 'TOKEN'}</span>
              </>
            }
          />
          ...
          <BlueLineStat
            ...
            value={
              <>
                ...
                <span className='text-default-soft opacity-60'>{ticketSymbol || 'TICKET'}</span>
              </>
            }
          />
        </StatContainer>
