...
export const TextInputGroup = (props) => {
  const { id, label, required, disabled, type, pattern, onChange, rightLabel, value } = props

  return (
    <>
      <div className='input-fieldset py-2 mb-0 text-sm'>
        <div
        ...
        >
          <label
            htmlFor={id}
            className={classnames('pl-4 mt-0 trans text-default', {
              'w-full': !rightLabel,
          ...
          {rightLabel && (
            <>
              <label
                className={classnames('mt-0 pb-1 sm:pr-4 sm:pl-2 trans text-right w-1/2', {
