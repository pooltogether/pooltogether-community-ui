...
const MATIC_VIGIL_RPC_URL = 'https://matic-mainnet.chainstacklabs.com'
// const POLYGON_QUIKNODE_RPC_URL =
//   'https://blue-wandering-sunset.matic.quiknode.pro/d42812c1b86a63689c034bda650c4c5daf6eb075/'
const providerCache = {}
  ...
  try {
    if (chainId) {
      ...
      if (network && ETHEREUM_NETWORKS.includes(chainId)) {
        ...
        provider = new ethers.providers.JsonRpcProvider(MATIC_VIGIL_RPC_URL)
