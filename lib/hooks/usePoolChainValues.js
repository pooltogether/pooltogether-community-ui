...
import { DATA_REFRESH_POLLING_INTERVAL, PRIZE_POOL_TYPE } from 'lib/constants'
...
export const fetchPoolChainValues = async (
  ...
  console.log('fetchPoolChainValues')
  ...
  if (provider && prizeStrategy && ticket && sponsorship && prizePool) {
    try {
      ...
      setPoolChainValues((existingValues) => ({
        ...
        ticketCreditRateMantissa: values.prizePool.creditPlanOf.creditRateMantissa[0],
        ticketCreditLimitMantissa: values.prizePool.creditPlanOf.creditLimitMantissa[0],
