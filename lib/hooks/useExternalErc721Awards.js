...
export const useExternalErc721Awards = () => {
  ...
  useEffect(() => {
    if (!readProviderLoaded || !poolAddresses.prizePool || !poolChainValues.externalErc721Awards) return
  ...
  }, [readProviderLoaded, provider, poolAddresses.prizePool, poolChainValues.externalErc721Awards])
