...
import StakePrizePool310Abi from 'lib/abis/StakePrizePool310'
import StakePrizePool320Abi from 'lib/abis/StakePrizePool320'
// import StakePrizePool320Abi from '@pooltogether/pooltogether-contracts/abis/StakePrizePool'
...
export const usePoolAddresses = () => {
  ...
  const prizePoolAddress = useMemo(() => {
    return poolAlias ?
      POOL_ALIASES[poolAlias]?.poolAddress :
