...
import { prizePoolTypeAtom, prizePoolTypeOverrideAtom } from 'lib/hooks/usePrizePoolType'
...
export const usePoolAddresses = () => {
  ...
  const [prizePoolTypeOverride] = useAtom(prizePoolTypeOverrideAtom)
  ...
  useEffect(() => {
    ...
    setPrizePoolType(prizePoolTypeOverride || '')
    setPoolChainValues({
      loading: true
    })
  }, [prizePoolAddress])
