...
const getContractVersions = async (
  ...
  console.log({ bytecode: prizePoolByteCode })

  window.CONTRACT_VERSIONS = CONTRACT_VERSIONS;
      ...
      <div className='flex flex-col mt-4'>
        {network.name === 'rinkeby' && (
          <>
            ...
            <Button className='mt-4' color='secondary' href={`/pools/mainnet/${prizePool}`}>
              Go
            </Button>
          </>
        )}
        {network.name === 'mainnet' && (
          <>
            ...
            <Button className='mt-4' color='secondary' href={`/pools/rinkeby/${prizePool}`}>
              Go
            </Button>
          </>
        )}
