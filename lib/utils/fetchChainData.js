...
export const fetchPoolAddresses = async (provider, poolAddresses, setPoolAddresses) => {
...
export const fetchGenericChainValues = async (provider, poolAddresses, setGenericChainValues) => {
