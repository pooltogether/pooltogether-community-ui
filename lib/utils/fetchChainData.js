  ...
  if (
    ...
    try {
      ...
      setGenericChainValues(existingValues => ({
        ...
        estimateRemainingPrize: values.singleRandomWinner.estimateRemainingPrize[0],
        ...
        ticketCreditRateMantissa: values.prizePool.creditRateOf.creditRateMantissa,
        ticketCreditLimitMantissa: values.prizePool.creditRateOf.creditLimitMantissa,
