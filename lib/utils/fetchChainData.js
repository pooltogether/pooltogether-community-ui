...
export const fetchChainData = async (
  ...
  console.log('fpa')
  await fetchPoolAddresses(walletContext, poolAddresses, setPoolAddresses)

  console.log('fgc')
  await fetchGenericChainValues(walletContext, poolAddresses, setGenericChainValues)

  if (walletContext.state.address) {
    fetchUserChainValues(walletContext, poolAddresses, setUserChainValues)
  }
}