...
export const fetchGenericChainValues = async (
  ...
  if (
    ...
    try {
      ...
      // console.log(values.pool.estimatePrize)
      // console.log(values.pool.estimateRemainingPrize)
      ...
      setChainValues(existingValues => ({
        ...
        estimateRemainingPrize: values.pool.estimateRemainingPrize[0],
