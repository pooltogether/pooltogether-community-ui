...
export const formatBlockExplorerTxUrl = (tx, networkId) => {
  try {
    ...
    console.warn(
      `formatBlockExplorerTxUrl: No block explorer for Chain: ${networkId} Chain ID not supported`
    )
  }
}
...
export const formatBlockExplorerAddressUrl = (address, networkId) => {
  try {
    ...
    console.warn(
      `formatBlockExplorerAddressUrl: No block explorer for Chain: ${networkId} Chain ID not supported`
    )
  }
}
